      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {project.tags.map((tag, index) => (
            <span
              key={index}
              className="bg-gray-200 text-gray-950 px-3 py-1 rounded-full text-sm"
            >
              {tag}
            </span>
          ))}
        ...
        <div className="flex space-x-3">
          <a
            ...
            className="bg-lime-400 text-gray-950 px-4 py-2 rounded-lg text-sm hover:bg-orange-600 transition-colors"
          >
            Ver Proyecto
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-violet-500 text-white px-4 py-2 rounded-lg text-sm hover:bg-orange-600 transition-colors flex items-center gap-1"
          >
            <svg
